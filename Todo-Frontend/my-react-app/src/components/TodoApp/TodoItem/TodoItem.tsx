...
export const TodoItem: React.FC = () => {
    ...
    const handleImageClick = (event: React.MouseEvent<HTMLElement>, id: number | null) => {
        if (!isEditing) return;
            ...
            reader.onload = () => {
                ...
                if (taskId !== null && todo) {
                    ...
                    if (task) {
                        ...
                        apiService.updateTask(taskId, updatedTask)
            ...
            <ImageMenu
                ...
                onAddPhoto={() => {
                    if (fileInputRef.current) {
                        fileInputRef.current.dataset.taskId = activeTaskId?.toString() || 'new';
                ...
                onRemovePhoto={() => {
                    if (activeTaskId !== null && todo) {
                        ...
                        if (task) {
                            ...
                            setTodo({
                                ...todo,
                                tasks: todo.tasks.map(t => t.id === activeTaskId ? updatedTask : t)
                            });
                            apiService.updateTask(activeTaskId, updatedTask)
